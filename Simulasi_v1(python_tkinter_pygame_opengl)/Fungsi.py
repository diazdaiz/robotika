...
def transformasi_0(part):
    ...
    kurang(part.koordinat_sumbu_rotasi_servo, part.koordinat_sumbu_rotasi_servo, part.koordinat_sumbu_rotasi_servo_tertransformasi)
    kali(part.rotasi, part.koordinat_sumbu_rotasi_servo_tertransformasi, part.koordinat_sumbu_rotasi_servo_tertransformasi)
    tambah(part.koordinat_sumbu_rotasi_servo_tertransformasi, part.koordinat_sumbu_rotasi_servo, part.koordinat_sumbu_rotasi_servo_tertransformasi)
...
def transformasi_1(part, kaki, pe, di): #pentransformasi, ditransformasi
    ...
    kurang(part[kaki][di].koordinat_sumbu_rotasi_servo_tertransformasi, part[kaki][pe].koordinat_sumbu_rotasi_servo, part[kaki][di].koordinat_sumbu_rotasi_servo_tertransformasi)
    kali(part[kaki][pe].rotasi, part[kaki][di].koordinat_sumbu_rotasi_servo_tertransformasi, part[kaki][di].koordinat_sumbu_rotasi_servo_tertransformasi)
    tambah(part[kaki][di].koordinat_sumbu_rotasi_servo_tertransformasi, part[kaki][pe].koordinat_sumbu_rotasi_servo, part[kaki][di].koordinat_sumbu_rotasi_servo_tertransformasi)
