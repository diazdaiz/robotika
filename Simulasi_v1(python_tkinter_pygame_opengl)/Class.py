...
class Part:
    def __init__(self):
        ...
        self.koordinat_sumbu_rotasi_servo_tertransformasi=Matriks()
        self.rotasi=Matriks()
...
for i in range(32):
    part[0].append(Part())
    part[0][i].koordinat_sumbu_rotasi_servo_tertransformasi.banyak_baris=3
    part[0][i].koordinat_sumbu_rotasi_servo_tertransformasi.banyak_kolom=1
    
    part[1].append(Part())
    part[1][i].koordinat_sumbu_rotasi_servo_tertransformasi.banyak_baris=3
    part[1][i].koordinat_sumbu_rotasi_servo_tertransformasi.banyak_kolom=1
...
part[0][27].urutan_transformasi=[27]

part[1][0].urutan_transformasi=[24,22,20,16,18,14,13,26,2,0]
part[1][1].urutan_transformasi=[24,22,20,16,18,14,13,26,2,0,1]
part[1][2].urutan_transformasi=[24,22,20,16,18,14,13,26,2]
part[1][3].urutan_transformasi=[24,22,20,16,18,14,13,26,3]
part[1][4].urutan_transformasi=[24,22,20,16,18,14,13,26,4]
part[1][5].urutan_transformasi=[24,22,20,16,18,14,13,26,3,5]
part[1][6].urutan_transformasi=[24,22,20,16,18,14,13,26,4,6]
part[1][7].urutan_transformasi=[24,22,20,16,18,14,13,26,3,5,7]
part[1][8].urutan_transformasi=[24,22,20,16,18,14,13,26,4,6,8]
part[1][9].urutan_transformasi=[24,22,20,16,18,14,13,26,3,5,7,9]
part[1][10].urutan_transformasi=[24,22,20,16,18,14,13,26,4,6,8,10]
part[1][11].urutan_transformasi=[24,22,20,16,18,14,13,26,3,5,7,9,11]
part[1][12].urutan_transformasi=[24,22,20,16,18,14,13,26,4,6,8,10,12]
part[1][13].urutan_transformasi=[24,22,20,16,18,14,13]
part[1][14].urutan_transformasi=[24,22,20,16,18,14]
part[1][15].urutan_transformasi=[24,22,20,16,18,14,15]
part[1][16].urutan_transformasi=[24,22,20,16]
part[1][17].urutan_transformasi=[24,22,20,16,18,14,15,19,17]
part[1][18].urutan_transformasi=[24,22,20,16,18]
part[1][19].urutan_transformasi=[24,22,20,16,18,14,15,19]
part[1][20].urutan_transformasi=[24,22,20]
part[1][21].urutan_transformasi=[24,22,20,16,18,14,15,19,17,21]
part[1][22].urutan_transformasi=[24,22]
part[1][23].urutan_transformasi=[24,22,20,16,18,14,15,19,17,21,23]
part[1][24].urutan_transformasi=[24]
part[1][25].urutan_transformasi=[24,22,20,16,18,14,15,19,17,21,23,25]
part[1][26].urutan_transformasi=[24,22,20,16,18,14,13,26]
part[1][27].urutan_transformasi=[27]
'''
